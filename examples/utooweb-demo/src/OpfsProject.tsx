...
const FileTreeItem = React.memo(
  ({
    ...
    onFileClick,
    onDirectoryExpand,
  }: FileTreeItemProps & { onDelete?: (item: FileTreeNode) => Promise<void> }) => {
...
const OpfsProject = () => {
      ...
      <div style={{ height: '100%', width: '100%' }}>
        ...
        <div style={{ height: 'calc(100% - 2rem)' }}>
          <MonacoEditor
            ...
            width='100%'
            language={
              ['tsx', 'ts', 'jsx', 'js'].some((ext) => selectedFilePath.endsWith(ext))
                ? 'typescript'
  ...
  return (
    ...
    >
      ...
      >
        {isLoading && (
          <p style={{ textAlign: 'center', color: '#22c55e', fontWeight: 500 }}>Installing dependencies...</p>
        )}
        ...
        >
          <div style={{ height: '24px', width: '100%' }} /> {/* spacer div with height */}
          <button
            onClick={handleBuild}
