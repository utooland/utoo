...
export interface InitOutput {
  ...
  readonly closure114846_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure114849_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure117472_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure373_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure117524_externref_shim: (a: number, b: number, c: any, d: any) => void;
