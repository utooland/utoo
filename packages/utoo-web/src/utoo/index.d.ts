...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h5a5203fa1fd5182d: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__hd839357e2ecea90a: (a: number, b: number, c: any) => void;
