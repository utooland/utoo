...
export interface InitOutput {
  ...
  readonly closure115363_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h2ce973260553dde0: (a: number, b: number) => void;
  readonly closure117908_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure115360_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure104_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure118043_externref_shim: (a: number, b: number, c: any, d: any) => void;
