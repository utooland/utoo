...
export interface InitOutput {
  ...
  readonly closure118152_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure115607_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure115610_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h13262edabaa325f0: (a: number, b: number) => void;
  readonly closure118288_externref_shim: (a: number, b: number, c: any, d: any) => void;
