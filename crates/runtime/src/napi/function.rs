// N-API function bridge -- native callback -> V8 function.
// Ported from Deno's ext/napi/function.rs.
...
impl CallbackInfo {
    #[inline]
    pub fn new_raw(env: *mut Env, cb: napi_callback, data: *mut c_void) -> *mut Self {
