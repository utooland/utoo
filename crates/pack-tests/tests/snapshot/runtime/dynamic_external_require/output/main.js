...
function dynamicExternalRequire(request, externals) {
    if (typeof request !== 'string' || !hasOwnProperty.call(externals, request)) {
        const e = new Error(`Dynamic require "${String(request)}" is not declared as a CommonJS external`);
        e.code = 'MODULE_NOT_FOUND';
        throw e;
    }
    const runtimeRequest = externals[request];
    const runtimeRequireHook = globalThis[RUNTIME_REQUIRE_SYMBOL];
...
function factory () {
    const runtimeModuleIds = ["[project]/runtime/dynamic_external_require/input/index.js [library-server] (ecmascript)"];
    let exports;
...
if (typeof exports === 'object' && typeof module === 'object') {
    ...
    exports["DynamicExternalRequire"] = factory();
} else {
    globalThis["DynamicExternalRequire"] = factory();
}
})([
["main.js",
...
"[project]/runtime/dynamic_external_require/input/index.js [library-server] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__$5f$_turbopack_dynamic_external_require_map_$5f$__ = {
    ["node:path"]: "node:path",
    ["path-alias"]: "node:path",
    ["__proto__"]: "node:path"
};
const staticPath = __turbopack_context__.r("[externals]/node:path [external] (node:path, cjs)");
function staticBasename(value) {
    return staticPath.basename(value);
}
function load(request) {
    return __turbopack_context__.d(request, __TURBOPACK__$5f$_turbopack_dynamic_external_require_map_$5f$__);
}
...
["main.js", {"otherChunks":[],"runtimeModuleIds":["[project]/runtime/dynamic_external_require/input/index.js [library-server] (ecmascript)"]}],
]);
