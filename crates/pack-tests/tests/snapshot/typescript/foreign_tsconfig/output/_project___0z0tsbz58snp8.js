...
;
;
console.log('foo', __TURBOPACK__imported__module__65__["f"]);
console.log('prop', __TURBOPACK__imported__module__82__["f"]);
__turbopack_context__.s([]);
}),
]);

//# sourceMappingURL=_project___0z0tsbz58snp8.js.map